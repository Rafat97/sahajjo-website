...
if ($form_type == "signup_form") {
    ...
    MailSend(
        ...
        "<center><h1>Welcome</h1></center><br><br>Hi $fName ,<br><br> Thank yor for signing up <br><br>From,<br>sahajjo@sahajjo.ml",
        'sahajjo@sahajjo.ml'
    );
    SetMessage('message', "Thank you for registering . Please Login ");
    header("Location: $url");
    exit;
...
elseif ($form_type == "contact_us_form") {
    ...
    MailSend(
        $email,
        'For sign up new user',
        "<center><h1>Welcome</h1></center><br><br>Hi $name ,<br><br> Thank yor for Contacting us , <br><br>From,<br>sahajjo@sahajjo.ml",
        'sahajjo@sahajjo.ml'
    );
    header("Location: $url");
    exit;
